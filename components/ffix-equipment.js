...
const EQUIP = [
  { slot: 'WPN', name: 'TypeScript',   bonus: '+95 MAG', color: '#aa66ff' },
  { slot: 'ARM', name: 'Docker',        bonus: '+80 VIT', color: '#44ccff' },
  { slot: 'ACC', name: 'TikTok API',   bonus: '+60 SPD', color: '#ffcc00' },
  { slot: 'ADD', name: 'Open Source',  bonus: '+55 SPI', color: '#00cc55' },
]
